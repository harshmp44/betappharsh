...
const initWebRouter = (app) => {
  ...
  router.post('/api/userExist', accountController.userExists)
  ...
  router.get("/wallet/addBankUSDT", middlewareController, homeController.addBankUSDTPage);
  ...
  router.post(
    "/api/webapi/addBankUSDT",
    middlewareController,
    userController.addBankUSDT
  ); // register
  router.post(
    "/api/webapi/otp",
    middlewareController,
  ...
  router.post('/api/webapi/admin/filteredMember', adminController.middlewareAdminController, adminController.filteredMember);
  router.post('/api/webapi/admin/getTotalEarning', adminController.middlewareAdminController, adminController.getTotalEarning);
